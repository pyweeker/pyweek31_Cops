...
class GameView(arcade.View):
    ...
    def setup(self, level):
        ...
        self.early_spawn_enemy_list = arcade.SpriteList()
        ...
        self.crosshair_sprite.center_x = start_XY[0]
        self.crosshair_sprite.center_y = start_XY[1] + 100
